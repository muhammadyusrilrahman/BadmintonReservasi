<x-layouts.app :title="$title">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Tambah Promo</h1>
            <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Buat kode promo baru untuk diskon reservasi.</p>
        </div>
    </div>

    {{-- Form --}}
    <div class="max-w-2xl">
        <form method="POST" action="{{ route('kasir.promos.store') }}"
              ...
              x-data="{
                  ...
                  activationMode: '{{ old('activation_mode', 'manual') }}',
                  generateCode() {
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          ...
                          class="w-full px-4 py-2.5 text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500 transition resize-none">{{ old('description') }}</textarea>
            ...
            <div>
                ...
                <p class="text-xs text-slate-400 dark:text-slate-500 mt-1">Jumlah maksimal kode ini bisa digunakan. Kosongkan untuk unlimited.</p>
            ...
            <div x-show="activationMode === 'manual'" x-transition>
                <label class="flex items-center gap-3 cursor-pointer group">
                    ...
                    <span class="text-sm font-medium text-slate-700 dark:text-slate-300">Aktifkan sekarang</span>
                </label>
            </div>
